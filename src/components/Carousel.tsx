        ...
        <>
            ...
            <div {...props} className='w-[100vw] h-[86vh] animate-animate-appear cursor-pointer relative overflow-hidden m-auto'>
                <div className='w-full h-full absolute top-0 left-0 transition duration-500 scroll-smooth opacity-100' id='slider'>
                    <Image src="/images/dp1.jpg" fill={true} alt='' className='absolute left-0 top-0 w-full md:h-full h-[90%] transition-opacity duration-500 opacity-100  md:object-cover object-cover' />
                    <Image src="/images/dp2.jpg" fill={true} alt='' className='absolute transition-opacity duration-500 opacity-100 left-0 top-0 w-full md:h-full md:object-cover h-[90%]' />
                    <Image src="/images/dp3.jpg" fill={true} alt='' className='absolute transition-opacity duration-500 opacity-100 left-0 top-0 w-full md:h-full h-[90%] md:object-cover' onLoad={(e) => e.currentTarget.parentElement?.classList.replace('opacity-0', 'opacity-100')} />
                    ...
                    <div className='w-full h-full bg-black absolute z-40 bg-opacity-60 flex flex-col items-center justify-center gap-2 text-white'>
                        ...
                        <h1 className='text-[5rem] font-bold'>IEM-ICDC 2025</h1>
                        ...
                        {/* <button onClick={() => window.scrollTo(0, 650)} className='bg-primary text-sm font-bold mt-10 px-6 py-2 rounded hover:opacity-80'>
                            Know More
                        </button> */}

                        <ShiningButton label='Know More' onClick={() => window.scrollTo(0, 650)} />
